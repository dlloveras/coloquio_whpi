...
\vspace*{0.5cm}
\title[Tesis Doctoral (UBA)]{\bf\LARGE El ciclo de actividad coronal\\ y la génesis del viento solar}
\date{28 de Julio de 2022}
\author[Diego Lloveras]
       {{\bf Lic. Diego G. Lloveras}\\
       \vskip 0.1cm     
       \small  Director: Dr. Alberto M. V\'asquez \\
 Consejera de Estudios: Dra. Cristina H. Mandrini \\
 Lugar de trabajo: Instituto de Astronom\'ia y F\'isica del Espacio (UBA-CONICET)}
%\vskip -2cm
  \institute[] %\institute[IAFE]
  {\begin{center}
\framebox{\includegraphics[height=0.2\linewidth]{figuras/logo_IAFE.eps}}
\framebox{\includegraphics[height=0.2\linewidth]{figuras/logouba.png}}
\end{center}  }
\vskip -1cm
\begin{document}
