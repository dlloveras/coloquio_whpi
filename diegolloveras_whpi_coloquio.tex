...
\vspace*{0.5cm}
\title[WHPI Colloquia]{\bf\large Three-Dimensional Structure of the Corona During WHPI Campaign Rotations CR-2219 and CR-2223}
...
\bu This is consistent with the scenario where the SSW originates along open field lines closest to the streamer belt, while the FSW originates from the CHs.
\hskip 0.3cm
...
\begin{itemize}
%DEMT\\
  \item[\bu] We characterize the thermodynamic structure of the corona. DEMT analysis shows that progressively outer layers of the streamer exhibit decreasing coronal base density, increasing density scale height, and increasing temperature. Trends are all in accordance with previous DEMT studies (Lloveras et al., 2017, 2020).
