...
\author[Diego Lloveras]
       {{\bf D. Lloveras, A. Vásquez, F. Nuevo, R. Frazin, W. Manchester IV, N. Sachdeva, B. Van der Holst, P. Lamy, and H. Gilardy}\\
       \vskip 0.1cm
       {\footnotesize
       Grupo de estudios Heliofísicos de Mendoza, U. de Mendoza, Argentina\\ 
       Instituto de Astronomía y Física del Espacio (CONICET--UBA), Argentina\\ 
       Department of Climate and Space Sciences and Engineering, U. of Michigan, USA\\ 
       Laboratoire Atmosphéres, Milieux et Observations Spatiales, France.}}
%\vskip -1cm
...
\begin{itemize}
\item Introducción:\\
\bu Corona solar -- Ciclo de actividad -- Emisividad EUV/LB.
\item Instrumentos y Metodología:\\
\bu Tomografía Solar Rotacional (LB/EUV$\rightarrow$DEMT)\\
 
\bu Modelo magnético (PFSS)\\
\bu Trazado de líneas magnéticas.
\item Resultados: \\
\begin{itemize}
  \item Comparación de los tres últimos mínimos de actividad solar (DEMT).
  \vskip 0.3cm
  \item Modelo MHD 3D (AWSoM)\\
  \bu Comparación AWSoM vs DEMT\\
  \bu Comparación AWSoM vs tomografía LB
  \vskip 0.3cm
\item Viento solar\\
\bu Correlación de propiedades terminales con DEMT
\end{itemize}
\salto
...
\vskip 0.2cm
\begin{itemize}
  \item[\bu] {\sc awsom} O/C discrepancy due to lack of accuracy of boundary condition. \
\end{itemize}
}
%-------------------------------
...
\footnotesize
\begin{center}
\includegraphics[width=0.35\textwidth,clip=]{figuras/map_LASCOC2pB_CR2223_24hr-Cadence_Rmin225_Rmax825_IRmin25_IRmax60_60x60x120_BF2_r3D_l25e-5_vfinal_interpolado_2500_Rsun2223.eps}
\includegraphics[width=0.35\textwidth,clip=]{figuras/map_Ne_awsom_2223_ener_new_2505_Rsun2219.eps}
